...
import { fetchFeaturedBlogs } from "@/lib/data/blogs";
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 pb-16">
      ...
      {featuredBlogs.map((blog) => (
        <div
          key={blog.id}
          className="grid lg:grid-cols-2 gap-6 rounded-3xl border border-gray-200 bg-white p-6 md:p-8 shadow-sm"
        >
          <Image
          ...
          <div className="flex flex-col justify-center">
            ...
            <h3 className="text-3xl font-semibold mt-3">{blog.title}</h3>
